...
const RightSidebar = () => {
  return (
    <section className="w-[30%] mt-2 flex flex-col items-stretch h-fit-content px-6">
      <div className="backdrop-blur bg-black/10 sticky top-2">
      ...
      <div>
        <div className="flex flex-col rounded-xl bg-neutral-900 my-4">
          <h3 className="font-bold text-2xl my-4 p-4">Global Rankings</h3>
          <div>
        ...
        <div className="flex flex-col rounded-xl bg-neutral-900 my-4">
          <h3 className="font-bold text-2xl my-4 p-4">Regional Leagues</h3>
          <div>
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="hover:bg-white/10 p-4">
